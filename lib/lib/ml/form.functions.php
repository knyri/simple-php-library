...
/**
 * Class for easily managing form keys used to test for form validity and prevent
 * double submissions. Uses $_SESSION['FormKey'] to store it's data.
 * @author Ken
 *
 */
class FormKey{
	...
	/**
	 * Outputs the current key as a hidden form field.
